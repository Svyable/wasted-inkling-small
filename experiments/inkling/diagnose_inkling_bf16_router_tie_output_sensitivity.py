...
the complete temporary C candidate from PR #39 and must match the same
...
# Install the complete evidence-only temporary-source transforms from PR #39.
import run_inkling_portable_bf16_complete_layer as complete_runner  # noqa: F401
