...
expert quantization, private staged-directory opening, and synthetic
quantized token-to-logits inference are implemented. Public WASTE container
publication, public loader integration, quantized trunk execution, tokenizer
execution, and official-weight differential validation remain gated.**
